...
namespace PrintFramerAPI.Controllers
{
    ...
    ///    
    /// </remarks>
    /// <response code="200">Returns the cost of the frame in dollers. </response>
    /// <response code="400">If the amount of frame material is less than 20 inches or greater than 1000 inches.</response>
